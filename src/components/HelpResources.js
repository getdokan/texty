...
function HelpResources() {
  const resources = [
    {
      ...
      url: 'https://wptexty.com/docs/gateway-settings/',
    ...
    },
    {
      ...
      url: 'https://storepulse.co/contact/',
    ...
    },
    {
      ...
      url: 'https://feedback.storepulse.co/b/texty',
  ...
  const renderIcon = (icon) => {
    const icons = {
      docs: <FileText size={24} />,
      support: <MessageCircle size={24} />,
      feature: <Lightbulb size={24} />,
    };
      ...
      {resources.map((resource) => (
        ...
        >
          <div className="texty-help-resource-card__icon">
            <div className="texty-help-icon-circle">
          ...
          <a
            ...
            className="texty-help-resource-btn"
          >
            {resource.buttonText}
          </a>
        </div>
